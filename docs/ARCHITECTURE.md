...
| `pages/2_Train_on_cluster.py` | Pick a corpus + model family + training config → push the corpus and submit a SLURM job on the cluster; lists jobs submitted from this dashboard. |
